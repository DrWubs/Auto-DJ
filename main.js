...
window.app = $.extend(window.app, {
        ...
        init: function() {
                ...
                window.app.botMessage = $('<div id="bot-message"> Dr Wubs\' Auto DJ<span style="font-style: italic;"></span> <a href="#" style="text-decoration: none; color: yellow; font-weight: bold;">Turn off</a></div>');
